...
<head>
	...
	<link rel="stylesheet" href="style.css?p=28" />
...
?><body class="sale"> 
<!-- Главый экран START -->
	<header class="wr-main-screen xs_flex xs_column">
		<!-- <div class="sale-note">
		...
		<div class="container">
			<div class="main-screen">
				<h1>Крупнейший современный образовательный портал в сфере индустри и моды</h1>
				<div class="attract xs_flex">
					<div class="item">
						Всё самое интересное о моде в одном месте
					</div>
					<div class="item">
						Ведущиие эксперты из разных стран мира
					</div>
					<div class="item">
						Более 1 тысячи качественных материалов
					</div>
					<div class="item">
						Новейшие тренды индустрии моды
					</div>
				</div>
			</div>
		</div>
